...
public class FalconConverterPrometheus {
	...
	public String convertToPrometheusRules(List<StrategyDTO> strategyDTOS) throws SQLException {
	...
	private static String convertJsonRuleToYaml(StrategyDTO strategyDTO) throws Exception {
		String metric = strategyDTO.getMetric();
		String tags = strategyDTO.getTags();
		String func = strategyDTO.getFunc();
		String op = strategyDTO.getOp();
		String rightValue = strategyDTO.getRightValue();
		...
		yaml.append("  ").append("- alert: ")
				.append(tags)
				.append("_")
				.append(metric)
				.append("\n");
		yaml.append("  ").append("  expr: \n");
		yaml.append("  ").append("    ")
				.append(promQL)
				.append("\n");
		yaml.append("  ").append("  for: 0m\n");
		yaml.append("  ").append("  labels:\n");
		yaml.append("  ").append("    severity: ")
				.append(severity)
				.append("\n");
		yaml.append("  ").append("  annotations:\n");
		yaml.append("  ").append("    summary: ")
